...
public class HowToWriteFile {
    ...
    static String filePath = "working-with-io/src/main/resources/write_to_me.txt";
...
//        Files.writeString(Path.of(filePath), "another str\n", StandardOpenOption.CREATE_NEW);
        ...
        Files.writeString(Path.of(String.format("working-with-io/src/main/resources/write_to_me-%s.txt",
